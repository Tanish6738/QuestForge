...
export default function GoalDetailPage() {
  ...
  const [quests, setQuests] = useState({ main: [], sub: [], side: [], all: [] });
    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)' }}>
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-2xl font-bold text-gradient">{goal?.title}</h1>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {['all', 'main', 'sub', 'side', 'available', 'active', 'completed', 'failed'].map(filterType => (
            <button
              key={filterType}
          ...
          <AnimatePresence>
            {filteredQuests.length > 0 ? (
              ...
              >
                ...
                <p style={{ color: 'var(--color-text-secondary)' }}>
                  {filter === 'all' 
                    ? "No quests have been generated for this goal yet."
                    : `No ${filter} quests for this goal.`
                  }
                </p>
              </motion.div>
            )}
